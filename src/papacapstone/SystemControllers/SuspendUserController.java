...
/**
 * Controller which suspends a user's account.
 * 
...
public class SuspendUserController extends HttpServlet {
	...
	/**
	 * Retrieves the current user, and suspends their account.
	 */
	protected void doPost(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			uqMgr.suspendUser(userName);
			uqMgr.closeConnection();

			String message = "I PUT U OUTSIDE.";
