...
<head>
<title>Browse Your Uploaded Games</title>
...
<body>
	...
	<sql:query dataSource="${snapshot}" var="result">
	           SELECT URL,Author,Title,ClassID,uploadDate, Rating FROM FILEDATA WHERE Author="${user.username}";
	    </sql:query>
	...
	<div id="displaySelectedChoices">
		<form action="FilesystemController" method="POST"
			...
			<br>
			<br> <input type="submit" class="blackButton"
